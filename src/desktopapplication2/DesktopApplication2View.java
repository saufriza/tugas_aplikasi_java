...
public class DesktopApplication2View extends FrameView {
    ...
    public void newRecord() {
        desktopapplication2.Tblmahasiswa t = new desktopapplication2.Tblmahasiswa();
    ...
    public void deleteRecord() {
        ...
        List<desktopapplication2.Tblmahasiswa> toRemove = new ArrayList<desktopapplication2.Tblmahasiswa>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            desktopapplication2.Tblmahasiswa t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<desktopapplication2.Tblmahasiswa> merged = new ArrayList<desktopapplication2.Tblmahasiswa>(list.size());
                for (desktopapplication2.Tblmahasiswa t : list) {
    ...
    private void initComponents() {
        ...
        nimLabel.setText(resourceMap.getString("nimLabel.text")); // NOI18N
        nimLabel.setName("nimLabel"); // NOI18N

        namaLabel.setText(resourceMap.getString("namaLabel.text")); // NOI18N
        namaLabel.setName("namaLabel"); // NOI18N

        jurusanLabel.setText(resourceMap.getString("jurusanLabel.text")); // NOI18N
        jurusanLabel.setName("jurusanLabel"); // NOI18N

        fakultasLabel.setText(resourceMap.getString("fakultasLabel.text")); // NOI18N
        fakultasLabel.setName("fakultasLabel"); // NOI18N

        nimField.setName("nimField"); // NOI18N
        ...
        jurusanField.setName("jurusanField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.jurusan}"), jurusanField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), jurusanField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        fakultasField.setName("fakultasField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.fakultas}"), fakultasField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue(null);
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), fakultasField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(nimField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(namaField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(jurusanField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
                    .addComponent(fakultasField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(mainPanelLayout.createSequentialGroup()
                .addContainerGap()
    ...
    private java.util.List<desktopapplication2.Tblmahasiswa> list;
